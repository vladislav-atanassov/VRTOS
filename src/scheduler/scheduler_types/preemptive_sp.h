 ...
 * Description: Preemptive static priority-based Scheduler (Preemptive static priority-based) Interface
 * Author: Student
 * Date: 2025
 ******************************************************************************/
 ...
 * This allows the scheduler manager to access Preemptive static priority-based Scheduler functionality.
 */
 ...
 *
 * Preemptive static priority-based Scheduler uses priority-based ready lists and a single time-sorted delayed list
 */
typedef struct {
...
static preemptive_sp_private_data_t g_preemptive_sp_data = {
    .ready_lists = {NULL},
    .delayed_list = NULL,
    .ready_priorities = 0};
